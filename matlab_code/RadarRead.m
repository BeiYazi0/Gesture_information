function RadarRead(loadCfg,filename,freadnums)
clc;
close all;
clear all;
if nargin==0
    loadCfg=0;
    filename='adc_data.mat';
    freadnums=1;
end
if(loadCfg)
    ...
    hdataSerialPort = configureDataSport(dataSerialPort,8e4);%链接 COM串口
